package com.htgames.nutspoker.ui.helper.Alipay;
...
public class OrderInfoUtil {
    ...
    public static String getOrderInfo(String subject, String body, String price) {
        ...
        // 签约合作者身份ID
        String orderInfo = "partner=" + "\"" + PayHelp.PARTNER + "\"";

        // 签约卖家支付宝账号
        orderInfo += "&seller_id=" + "\"" + PayHelp.SELLER + "\"";
    ...
    public static String sign(String content) {
        return SignUtils.sign(content, PayHelp.RSA_PRIVATE);
    }
