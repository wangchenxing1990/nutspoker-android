...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    private final static String TAG = "PagerSlidingTabStrip";
    ...
    private int underlineColor = 0x4cffffff;
...
//    private View animationInviteBottomView;
...
//        a.recycle();
    ...
    public void setAnimationView(View view , View twoView) {
//        this.animationBottomView = view;
//        this.animationInviteBottomView = twoView;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            if (pager.getAdapter() instanceof IconTabProvider && ((IconTabProvider) pager.getAdapter()).showIcon()) {
//                addIconTab(i, ((IconTabProvider) pager.getAdapter()).getPageIconResId(i));
                addTextIconTab(i, pager.getAdapter().getPageTitle(i).toString(), ((IconTabProvider) pager.getAdapter()).getPageIconResId(i));// TODO: 16/12/19 新版本不需要icon了
            } else {
    ...
    private void addTextIconTab(final int position, String title , int iconId) {
        TextView tab = new TextView(getContext());
        tab.setText(title);
        tab.setGravity(Gravity.CENTER);
        tab.setSingleLine();
        ...
        tab2.setSingleLine();
        tab2.setIncludeFontPadding(false);
        tab2.setCompoundDrawablePadding(0);
        //
        Drawable drawable = getResources().getDrawable(iconId);
        int iconWidth = drawable.getIntrinsicWidth() * 2 / 3 ;
        int iconHeight = drawable.getIntrinsicHeight() * 2 / 3;
        drawable.setBounds(0, 0, iconWidth, iconHeight);
        tab2.setCompoundDrawables(drawable, null, null, null);
    ...
    private void scrollToChild(int position, int offset) {
        if (tabCount == 0 || tabsContainer == null || position >= tabsContainer.getChildCount() || tabsContainer.getChildAt(position) == null) {
            return;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float lineLeft = currentTab == null ? 0 : currentTab.getLeft();
        float lineRight = currentTab == null ? 0 : currentTab.getRight();
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            //底部跟着变化的VIEW
//            if(animationBottomView != null && animationInviteBottomView != null) {
//                if (position == (tabCount - 1)) {
//                    ViewHelper.setAlpha(animationBottomView, 0f);
//                    ViewHelper.setAlpha(animationInviteBottomView, 0f);
//                } else {
//                    ViewHelper.setAlpha(animationBottomView, 1f);
//                    ViewHelper.setAlpha(animationInviteBottomView, 1f);
//                }
//            }
...
//                    ViewHelper.setAlpha(animationBottomView, 1 - positionOffset);
//                    ViewHelper.setAlpha(animationInviteBottomView, 1 - positionOffset);
//                    Log.d(TAG, position + ";positionOffset :" + positionOffset);
//                } else if (position == (tabCount - 1)) {
//                    ViewHelper.setAlpha(animationBottomView, positionOffset);
//                    ViewHelper.setAlpha(animationInviteBottomView, positionOffset);
//                    Log.d(TAG, position + ";positionOffset :" + positionOffset);
//                }
//            }
        }
