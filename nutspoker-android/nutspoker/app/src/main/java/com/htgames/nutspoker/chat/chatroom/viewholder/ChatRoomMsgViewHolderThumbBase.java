 ...
 */
public abstract class ChatRoomMsgViewHolderThumbBase extends MsgViewHolderThumbBase {
    ...
    private void loadThumbnailImage(String thumbPath) {
        ...
        if (thumbPath != null) {
            ...
            thumbnail.loadAsResource(com.netease.nim.uikit.R.drawable.nim_image_default, 30, 20, maskBg());
        }
    }
