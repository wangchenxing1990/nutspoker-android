...
//        mButton.setText(mCollapsed ? R.string.circle_content_packup : R.string.circle_content_all);//是否收缩
        checkCollapsedUI();
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
    ...
    public void checkCollapsedUI(){
        mButton.setText(mCollapsed ? R.string.circle_content_all : R.string.circle_content_packup);//是否收缩
    }
