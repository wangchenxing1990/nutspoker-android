...
public class HordeRecordFragment extends BaseFragment implements IClick {
    public static final String TAG = HordeRecordFragment.class.getSimpleName();
    String sessionId;
    ...
    public static HordeRecordFragment newIntance() {
        HordeRecordFragment mInstance = new HordeRecordFragment();
...
//        recordList.addAll(GameRecordDBHelper.getGameRecordListByTid(getActivity(), sessionId));
        ...
        if (getActivity() instanceof HordeHallAC) {
            ...
            sessionId = ((HordeHallAC) getActivity()).teamId;
        }
    ...
    private void initSearch() {
        ...
        edit_search_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RecordSearchAC.Companion.startByMyList(getActivity(), edit_search_record, RecordSearchAC.Companion.getSEARCH_TYPE_HORDE_LIST(), sessionId, mHordeEntity == null ? "" : mHordeEntity.horde_id);
            }
        });
    }
    ...
    IClick clickListener = new IClick() {
        @Override
    ...
    private void getNetRecordList(final String lastGid) {
        if (true) {
        ...
        isLoadMore = true;
        mRecordAction.getRecordListForHorde(sessionId, lastGid, mHordeEntity == null ? "" : mHordeEntity.horde_id, new GameRequestCallback() {
            @Override
...
//            mAdapter.onLoadMoreComplete(newItems);
    ...
    public synchronized void getNetRecordGids(final String lastGid) {
        ...
        isLoadMore = true;
        mRecordAction.getRecordListGidsHorde(lastGid, sessionId, mHordeEntity == null ? "" : mHordeEntity.horde_id, "", new RequestCallback() {
            @Override
                                        ...
                                        try {
                                            ...
                                            if (TextUtils.isEmpty(lastGid)) {
                                                if (list != null) {
                                                    ...
                                                    Collections.sort(pageRecordList, RecordListAC.recordComp);
                                                    recordList.clear();
