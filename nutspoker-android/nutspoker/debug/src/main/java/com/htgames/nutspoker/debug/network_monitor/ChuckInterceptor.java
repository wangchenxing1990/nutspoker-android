...
//        RequestBody requestBody = request.body();
        RequestBody requestBody = VolleyInterceptor.getRequestBody(request.url().toString());
        boolean hasRequestBody = requestBody != null;

        HttpTransaction transaction = new HttpTransaction();
        transaction.requestDate = (new Date());
        LogUtil.i("zzh 请求时间", transaction.requestDate.getTime() + "");
        ...
        LogUtil.i("zzh 回调时间", transaction.responseDate.getTime() + "");
