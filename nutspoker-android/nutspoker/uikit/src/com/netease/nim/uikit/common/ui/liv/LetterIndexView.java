...
public class LetterIndexView extends View {
    ...
    private String[] originalLetters = null;
    ...
    public LetterIndexView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        originalLetters = paramContext.getResources().getStringArray(stringArrayId);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < letters.length; ++i) {
            ...
            float letterPosY = letterHeight * i + textSize + padding * (i + 1);
    ...
    private void onHit(float offset) {
        this.offset = offset;
        if (hit && listener != null && letters != null && letters.length > 0) {
