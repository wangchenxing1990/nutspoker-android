...
public class EasyAlertDialogHelper {
	...
	public static EasyAlertDialog createOneButtonDiolag(Context mContext, CharSequence titleString, CharSequence msgString,
														CharSequence btnString, boolean cancelable, final OnClickListener positiveListener) {
		final EasyAlertDialog dialog = new EasyAlertDialog(mContext);
		if (TextUtils.isEmpty(titleString)) {
			dialog.setTitleVisible(false);
	...
	public static EasyAlertDialog createOkCancelDiolag(Context context, CharSequence title, CharSequence message,
													   CharSequence okStr, CharSequence cancelStr, boolean cancelable, final OnDialogActionListener listener, int style) {
		final EasyAlertDialog dialog = new EasyAlertDialog(context, style);
		OnClickListener okListener = new OnClickListener() {
			public void onClick(View v) {
				dialog.dismiss();
				listener.doOkAction();
	 ...
	 */
	public static EasyAlertDialog createOkCancelDiolag(Context context, CharSequence title, CharSequence message,
													   CharSequence okStr, CharSequence cancelStr, boolean cancelable, int layoutId, final OnDialogActionListener listener) {
		final EasyAlertDialog dialog = new EasyAlertDialog(context, layoutId, R.style.dialog_default_style);
		OnClickListener okListener = new OnClickListener() {
			public void onClick(View v) {
				dialog.dismiss();
				listener.doOkAction();
