...
//        }
    ...
    private static void showMessageOKCancel(final Activity context, String message, final DialogInterface.OnClickListener okListener) {
        EasyAlertDialog nicknameExistedDialog = EasyAlertDialogHelper.createOneButtonDiolag(context, "",
                message, context.getString(R.string.ok), false,
