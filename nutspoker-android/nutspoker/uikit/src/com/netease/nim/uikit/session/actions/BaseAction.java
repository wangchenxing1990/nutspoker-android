 ...
 * requestCode仅能使用最低8位。
 * we can use implementation "android.arch.lifecycle:runtime:1.0.0" and annotationProcessor "android.arch.lifecycle:compiler:1.0.0-beta1" to handle lifecycle events
 * in this class, see this blog post https://android.jlelse.eu/is-your-android-library-lifecycle-aware-127629d32dcc for detail.
 */
