...
public class ContactDataAdapter extends BaseAdapter {
    ...
    public final LivIndex createLivIndex(ListView lv, LetterIndexView liv, TextView tvHit) {
        mLivIndex = new LivIndex(null, lv, liv, tvHit, getIndexes());
        return mLivIndex;
    }
    //
    // BaseAdapter
    ...
    private void updateIndexes(Map<String, Integer> indexes) {
        ...
        /**这里暂时先注释，以后需要优化，没有的索引不需要显示
//        Set<String> list = indexes.keySet();
//        TreeSet<String> treeSet = new TreeSet<>();
//        treeSet.addAll(list);
//        String[] newStrArray = treeSet.toArray(new String[]{});
//        if (mLivIndex != null)
//            mLivIndex.updateLetters(newStrArray);
         */
    }
}
