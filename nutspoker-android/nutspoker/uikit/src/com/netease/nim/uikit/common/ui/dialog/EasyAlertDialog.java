...
//            setContentView(resourceId);
            ...
            this.resourceId = R.layout.nim_easy_alert_dialog_default_layout;
        }
    ...
    private int message2TVGravity = Gravity.CENTER;

    public void setMessage2GravityLeft(){
        message2TVGravity = Gravity.LEFT | Gravity.CENTER_VERTICAL;
        if (null != message2TV) {
            message2TV.setGravity(message2TVGravity);
        }
    }
    ...
    public void addPositiveButton(CharSequence title, int color, float size,
        ...
        positiveBtnTitle = TextUtils.isEmpty(title) ? getContext()
    ...
    public void addNegativeButton(CharSequence title, int color, float size,
        ...
        negativeBtnTitle = TextUtils.isEmpty(title) ? getContext()
