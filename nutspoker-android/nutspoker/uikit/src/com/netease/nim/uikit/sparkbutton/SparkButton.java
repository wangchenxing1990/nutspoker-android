package com.netease.nim.uikit.sparkbutton;
...
import com.netease.nim.uikit.sparkbutton.heplers.CircleView;
import com.netease.nim.uikit.sparkbutton.heplers.DotsView;
import com.netease.nim.uikit.sparkbutton.heplers.Utils;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    void init() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.jhs_jui_spark_button, this, true);
        circleView = (CircleView) findViewById(R.id.jhs_spartbutton_circle);
        ...
        dotsView = (DotsView) findViewById(R.id.jhs_spartbutton_dots_view);
        ...
        imageView = (ImageView) findViewById(R.id.jhs_sparkbutton_image);
...
//        setOnTouchListener();
    ...
    private void getStuffFromXML(AttributeSet attr) {
        ...
        primaryColor = ContextCompat.getColor(getContext(), a.getResourceId(R.styleable.sparkbutton_sparkbutton_primaryColor, R.color.nutspoker_primary_color));
        secondaryColor = ContextCompat.getColor(getContext(), a.getResourceId(R.styleable.sparkbutton_sparkbutton_secondaryColor, R.color.nutspoker_spark_secondary_color));
