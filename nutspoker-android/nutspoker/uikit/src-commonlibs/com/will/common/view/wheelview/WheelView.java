...
//	private static final int VALUE_TEXT_COLOR = 0xF0000000;
	private static final int VALUE_TEXT_COLOR = 0xFF96999C;//shop_text_no_select_color   0xF0ffffff;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF96999C;//shop_text_no_select_color   0xFFffffff;
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			float textWidth = ceil(Layout.getDesiredWidth("0",
					itemsPaint));
		...
		if (label != null && label.length() > 0) {
			labelWidth = (int) ceil(Layout.getDesiredWidth(label, valuePaint));
		}
...
//		centerDrawable.draw(canvas);
		...
		linePaint = new Paint();
		linePaint.setColor(context.getResources().getColor(R.color.wheelview_divider_color));
		linePaint.setAntiAlias(true);
		canvas.drawLine(0, center - offset, getWidth(), center - offset, linePaint);
		canvas.drawLine(0, center + offset, getWidth(), center + offset, linePaint);
		canvas.drawRect(0, center - offset, getWidth(), center + offset, linePaint);
	}
